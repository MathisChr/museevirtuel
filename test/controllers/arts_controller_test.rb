...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { author: @art.author, date: @art.date, description: @art.description, dimensions: @art.dimensions, photo: @art.photo, titles: @art.titles } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { author: @art.author, date: @art.date, description: @art.description, dimensions: @art.dimensions, photo: @art.photo, titles: @art.titles } }
